    ...
    protected static function workerStart() {
        ...
        self::$serv->on('Task', function ($serv, $task_id, $src_worker_id, $data) use ($config) {
            ...
            switch ($dataArr['server']) {
                case "tcp":
                    $rs = $task::tcp_task_run($serv, $task_id, $src_worker_id, $data);
                    break;
                case "ws":
                    $rs = $task::ws_task_run($serv, $task_id, $src_worker_id, $data);
                    break;
                case "http":
                    $rs = $task::http_task_run($serv, $task_id, $src_worker_id, $data);
                    break;
            }
            return $rs;
        });
